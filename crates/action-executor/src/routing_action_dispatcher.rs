...
/// send-as-user via `GraphSendMailActionDispatcher`; everything else (including `Email` actions
/// still configured as a webhook, for backward compatibility with ADR-0007's original
